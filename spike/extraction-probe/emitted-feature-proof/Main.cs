...
// emitted code. Same behaviour the leverage probe proved (add an item to a cart,
// wiring load-bearing), but here the handler was emitted from a fully TYPE-SAFE recipe:
// the scaffold was derived from the generics and the glue was lifted from real,
// compiler-checked lambdas. No string was authored anywhere upstream.
