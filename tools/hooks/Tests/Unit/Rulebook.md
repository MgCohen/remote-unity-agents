...
<!-- id: glob-matches-across-directories-and-within-a-single-segment -->
...
<!-- id: hookmanifestparser-parses-a-well-formed-hook-into-its-kinds-when-filter-mode-and-run-command -->
...
<!-- id: hookmanifestparser-rejects-a-hook-missing-on-or-an-action-with-an-actionable-error-naming-the-file -->
...
<!-- id: hookmanifestparser-parses-agent-into-a-spawn-agent-action-carrying-the-prompt -->
...
<!-- id: hookmanifestparser-rejects-a-hook-that-sets-both-run-and-agent -->
...
<!-- id: hookevent-round-trips-through-its-jsonl-line-preserving-kind-source-ids-and-raw-payload -->
...
<!-- id: hookevent-tryparse-rejects-a-malformed-or-kindless-line -->
...
<!-- id: hookmanifest-matches-gates-on-event-kind-and-the-when-filter -->
...
<!-- id: hookcatalog-discovers-hook-files-under-its-scan-roots-and-reports-a-malformed-one-instead-of-throwing -->
...
<!-- id: hookdispatcher-runs-the-matching-notify-and-check-hooks-not-gate-feeding-the-event-on-stdin -->
...
<!-- id: hookdispatcher-routes-an-agent-action-to-the-agent-launcher-not-the-shell-and-relays-its-output -->
...
<!-- id: hookcontroller-dispatches-the-pending-log-slice-once-and-advances-the-cursor-past-completed-lines -->
...
<!-- id: gitinstaller-installpostcommit-on-a-default-repo-writes-an-executable-post-commit-that-calls-abox-hooks-commit -->
...
<!-- id: gitinstaller-installpostcommit-on-a-repo-with-a-custom-core-hookspath-refuses-without-writing-a-hook -->
...
<!-- id: abox-hooks-commit-in-an-opted-in-repo-appends-a-commitlanded-line-and-dispatches-matching-hooks -->
...
<!-- id: abox-hooks-commit-with-no-abox-opt-in-emits-nothing -->
...
<!-- id: claudecodeinstaller-installstophook-wires-a-turn-ended-stop-hook-into-settings-preserving-existing-keys -->
...
<!-- id: claudecodeinstaller-installstophook-on-a-settings-already-wired-no-duplicate-stop-hook -->
...
<!-- id: abox-hooks-turn-ended-in-an-opted-in-repo-appends-a-turnended-line-from-the-stop-payload-and-dispatches -->
...
<!-- id: abox-hooks-turn-ended-with-a-passing-check-hook-returns-the-check-output-as-advisory-stop-context -->
...
<!-- id: abox-hooks-turn-ended-with-a-failing-check-hook-blocks-the-turn-feeding-the-check-output-back-as-the-reason -->
...
<!-- id: abox-hooks-turn-ended-honors-stop-hook-active-a-blocking-check-is-downgraded-to-context-not-re-blocked -->
...
<!-- id: abox-hooks-turn-ended-under-abox-hooks-suppress-no-op-so-a-hook-spawned-agent-can-t-re-trigger -->
...
<!-- id: abox-hooks-turn-ended-with-no-abox-opt-in-emits-nothing -->
