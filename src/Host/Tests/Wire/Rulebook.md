...
<!-- id: get-projects-the-stored-projects-as-wire-dtos -->
...
<!-- id: get-projects-id-the-project-or-404-when-absent -->
...
<!-- id: post-projects-a-created-project-rejecting-blank-name-blank-path-and-duplicate-names -->
...
<!-- id: put-projects-id-an-updated-project-rejecting-unknown-id-blank-fields-and-duplicate-names -->
...
<!-- id: delete-projects-id-the-project-removed-or-404-when-absent -->
...
<!-- id: first-boot-with-an-empty-store-the-legacy-projects-json-is-imported -->
...
<!-- id: get-git-prs-the-stub-pull-requests-as-wire-dtos -->
...
<!-- id: post-git-prs-number-merge-merged-for-a-known-pr-404-for-an-unknown-one -->
...
<!-- id: post-flows-then-get-flows-id-events-snapshots-stream-over-sse-to-completion -->
...
<!-- id: post-inbox-a-created-item-echoing-title-and-tags-with-timestamps-null-rejecting-a-blank-title -->
...
<!-- id: get-inbox-the-inbox-items-as-wire-dtos-filtered-by-tag -->
...
<!-- id: get-inbox-id-the-item-or-404-when-absent -->
...
<!-- id: post-inbox-id-seen-the-item-stamped-seen-or-404-when-absent -->
...
<!-- id: post-inbox-id-complete-the-item-stamped-complete-or-404-when-absent -->
...
<!-- id: post-decisions-a-created-decision-echoing-the-question-and-tags-unanswered-rejecting-a-blank-question -->
...
<!-- id: get-decisions-the-raised-decisions-as-wire-dtos -->
...
<!-- id: get-decisions-id-the-decision-or-404-when-absent -->
...
<!-- id: post-decisions-id-answer-the-decision-stamped-with-its-answer-or-404-when-absent -->
...
<!-- id: post-decisions-id-answer-with-no-answer-400-so-a-missing-answer-can-t-record-a-default-no -->
