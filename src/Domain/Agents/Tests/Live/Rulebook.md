...
<!-- id: a-ping-flow-with-a-trivial-prompt-the-agent-replies-and-the-run-completes -->
...
<!-- id: an-autonomous-agent-given-an-under-specified-prompt-self-resolves-and-completes-without-needs-input -->
...
<!-- id: an-agent-given-a-file-request-writes-the-file-into-the-project-on-disk -->
...
<!-- id: ask-policy-with-a-gated-tool-and-allow-the-hook-fires-and-the-write-goes-through -->
...
<!-- id: ask-policy-with-a-gated-tool-and-a-denial-the-write-is-blocked-and-the-run-does-not-hang -->
...
<!-- id: auto-policy-with-a-gated-tool-the-tool-runs-without-consulting-the-resolver -->
...
<!-- id: a-credentialed-live-turn-the-subscription-token-never-appears-in-the-drive-buffer -->
...
<!-- id: a-human-agent-given-a-registry-answer-resumes-and-completes -->
...
<!-- id: a-human-agent-with-no-answer-available-escalates-as-needs-input -->
...
<!-- id: the-agent-configured-machine-a-real-commit-lands-as-the-bot-never-the-owner-or-generic-default -->
