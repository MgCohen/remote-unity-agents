...
<!-- id: autopolicy-on-a-dangerous-bash-command-denied-with-a-guardrail-reason -->
...
<!-- id: autopolicy-on-an-ordinary-bash-command-auto-approved -->
...
<!-- id: autopolicy-on-a-payload-with-no-bash-command-to-inspect-allowed -->
...
<!-- id: autopolicy-with-a-custom-denylist-applies-only-those-rules-replacing-the-built-in-guardrails -->
...
<!-- id: denyresolver-on-a-permission-request-answers-deny -->
...
<!-- id: denyresolver-on-an-open-question-abstains-with-null -->
...
<!-- id: resolverselector-given-auto-the-auto-resolver-with-the-configured-cap -->
...
<!-- id: resolverselector-given-human-the-human-resolver-uncapped -->
...
<!-- id: resolverselector-given-deny-the-deny-resolver-uncapped -->
...
<!-- id: agent-with-a-needs-input-envelope-in-the-output-needsinput-carrying-the-question -->
...
<!-- id: agent-output-with-no-envelope-completed-with-the-final-text -->
...
<!-- id: agent-with-a-non-zero-exit-faulted-even-when-an-envelope-is-present -->
...
<!-- id: agent-that-resolves-its-question-resumes-and-completes-using-the-answer -->
...
<!-- id: agent-whose-question-gets-a-null-answer-stays-needsinput -->
...
<!-- id: agent-whose-question-loop-never-settles-faulted-when-the-cap-is-exhausted -->
...
<!-- id: a-factory-minted-agent-run-through-a-flow-a-completed-operation-whose-summary-is-the-agent-s-text -->
...
<!-- id: an-agent-across-successive-calls-reuses-the-session-minted-on-its-first-call -->
...
<!-- id: an-agent-s-first-call-a-request-carrying-the-prompt-and-baked-in-project-dir-with-no-session -->
...
<!-- id: a-completed-agent-outcome-a-transcript-with-the-agent-s-text-turn-and-a-session-id -->
...
<!-- id: agentrunrequest-with-a-blank-prompt-argumentexception -->
...
<!-- id: claudehooks-create-settings-file-wires-a-stop-hook-to-the-stop-shim -->
...
<!-- id: claudehooks-create-without-gating-no-pretooluse-hook-and-no-permission-dir -->
...
<!-- id: claudehooks-create-with-gating-pretooluse-perm-shim-hook-matching-the-mutating-tools-and-a-permission-dir -->
...
<!-- id: perm-shim-script-reads-the-stdin-payload-and-emits-a-permissiondecision-against-the-permission-dir -->
...
<!-- id: claudehooks-drainrequests-returns-each-pending-request-once-with-its-id-and-payload-then-nothing -->
...
<!-- id: claudehooks-drainrequests-with-gating-off-returns-empty -->
...
<!-- id: claudehooks-respond-writes-the-decision-to-the-response-file-matching-the-request-id -->
...
<!-- id: claudehooks-respond-with-gating-off-throws-invalidoperationexception -->
...
<!-- id: claudehooks-hasfired-reflects-whether-the-signal-file-has-content -->
...
<!-- id: claudehooks-readfinalmessage-returns-the-last-assistant-message-from-the-signal-file -->
...
<!-- id: claudehooks-readfinalmessage-with-missing-or-malformed-signal-returns-null -->
...
<!-- id: claudehooks-emitturnended-with-an-opted-in-project-appends-a-normalized-turnended-line-carrying-the-raw-stop-payload -->
...
<!-- id: claudehooks-emitturnended-with-no-abox-opt-in-dir-emits-nothing -->
...
<!-- id: claudehooks-dispose-removes-the-temp-artifacts-it-created -->
...
<!-- id: resolvesessionfile-with-a-staged-session-id-returns-the-matching-jsonl-path-regardless-of-folder-name -->
...
<!-- id: resolvesessionfile-with-an-unknown-session-id-returns-null -->
...
<!-- id: tryreadlastassistanttext-with-no-session-file-returns-null -->
...
<!-- id: tryreadlastassistanttext-for-a-turn-returns-the-assistant-s-reply-text-for-that-prompt -->
...
<!-- id: tryreadlastassistanttext-with-multiple-text-blocks-joins-them-newline-separated-in-order -->
...
<!-- id: tryreadlastassistanttext-with-thinking-and-tool-use-blocks-returns-only-the-text-blocks-excluding-reasoning-and-tool-noise -->
...
<!-- id: tryreadlastassistanttext-with-a-prompt-hint-anchors-on-the-matching-user-message-and-returns-that-turn-s-reply -->
...
<!-- id: tryreadlastassistanttext-with-no-prompt-hint-falls-back-to-the-last-user-turn-s-reply -->
...
<!-- id: tryreadlastassistanttext-with-tool-result-user-messages-ignores-them-as-turn-boundaries-and-spans-the-real-turn -->
...
<!-- id: tryreadlastassistanttext-with-bare-string-message-content-treats-it-as-a-single-text-block -->
...
<!-- id: tryreadlastassistanttext-with-an-assistant-turn-carrying-no-text-blocks-returns-an-empty-string -->
...
<!-- id: tryreadlastturntranscript-with-no-session-file-returns-null -->
...
<!-- id: tryreadlastturntranscript-for-a-turn-returns-every-block-thinking-text-tool-use-tool-result-tagged-with-its-kind-in-source-order -->
...
<!-- id: tryreadlastturntranscript-with-a-large-tool-use-input-preserves-the-full-tool-input-args-untruncated -->
...
<!-- id: claudepermission-toquestion-on-a-tool-call-an-allow-deny-choice-naming-the-tool-and-its-target -->
...
<!-- id: claudepermission-toquestion-on-an-unparseable-payload-a-still-valid-allow-deny-question-instead-of-a-throw -->
...
<!-- id: claudepermission-describe-on-a-tool-call-the-tool-name-and-its-full-untruncated-detail -->
...
<!-- id: claudepermission-toquestion-on-an-overlong-command-a-truncated-prompt-marked-with-an-ellipsis -->
...
<!-- id: claudepermission-renderresponse-with-a-decision-the-hook-specific-pretooluse-envelope-carrying-that-decision-and-reason -->
...
<!-- id: permissionmode-given-a-permission-policy-the-matching-claude-permission-mode-flag-value -->
...
<!-- id: buildargs-for-a-fresh-run-leads-with-session-id-and-omits-resume -->
...
<!-- id: buildargs-for-a-resumed-run-leads-with-resume-and-omits-session-id -->
...
<!-- id: buildargs-with-permission-mode-model-and-system-prompt-file-each-as-its-paired-flag-and-value -->
...
<!-- id: buildargs-with-a-settings-file-emits-settings-paired-with-that-path -->
...
<!-- id: buildargs-with-no-settings-file-omits-settings-entirely -->
...
<!-- id: buildargs-with-blank-optional-fields-omits-permission-mode-model-and-append-system-prompt-file -->
...
<!-- id: ispromptready-given-the-input-bar-footer-in-any-permission-mode-true -->
...
<!-- id: ispromptready-given-a-startup-dialog-screen-false -->
...
<!-- id: detectstartupdialog-given-a-known-dialog-s-text-its-startupdialog-classification -->
...
<!-- id: detectstartupdialog-given-ordinary-output-null -->
...
<!-- id: detectstartupdialog-given-dialog-text-split-by-ansi-escapes-still-classifies-it -->
...
<!-- id: envscrub-maps-each-agent-to-its-own-billing-keys-claude-scrubs-the-anthropic-keys-codex-the-openai-key -->
...
<!-- id: buildcredentiallauncher-reads-the-oauth-token-from-the-mount-file-in-box-and-never-embeds-the-token-value -->
...
<!-- id: buildboxenv-never-carries-the-credential-the-token-never-reaches-the-pty-echoed-exec-line -->
...
<!-- id: buildboxenv-with-an-egress-proxy-routes-the-box-out-through-https-proxy-and-http-proxy -->
...
<!-- id: a-credentialed-box-with-no-confining-network-or-proxy-refused-before-it-opens -->
...
<!-- id: a-credentialed-box-behind-the-egress-network-and-proxy-permitted-to-open -->
...
<!-- id: a-box-with-no-credential-permitted-to-open-without-egress-confinement -->
...
<!-- id: buildargs-with-no-session-id-a-fresh-exec-run-that-reads-the-prompt-from-stdin -->
...
<!-- id: buildargs-with-a-session-id-an-exec-resume-run-that-threads-that-session-id -->
...
<!-- id: buildargs-carries-the-working-dir-output-path-sandbox-bypass-model-and-json-flags -->
...
<!-- id: buildargs-with-a-blank-model-omits-the-model-flag-entirely -->
...
<!-- id: scansessionid-over-any-known-json-shape-the-embedded-session-id -->
...
<!-- id: scansessionid-when-no-valid-id-is-present-null -->
...
<!-- id: extracttranscript-over-a-completed-agent-message-a-single-text-turn-carrying-its-text -->
...
<!-- id: extracttranscript-over-a-command-execution-a-tooluse-turn-followed-by-a-toolresult-turn-with-exit-code-and-output -->
...
<!-- id: extracttranscript-over-a-completed-reasoning-item-a-single-thinking-turn-carrying-its-text -->
...
<!-- id: extracttranscript-over-mixed-tracing-and-incomplete-events-only-the-completed-items-become-turns -->
...
<!-- id: extracttranscript-over-empty-output-no-turns -->
...
<!-- id: agent-auto-resolves-a-question-the-decision-is-recorded-on-the-run-ledger-as-an-auto-sourced-answered-question -->
...
<!-- id: agent-emitting-needs-input-blocks-on-a-pending-decision-until-a-human-resolves-it-then-resumes-to-completed -->
...
<!-- id: run-cancelled-while-awaiting-a-decision-unblocks-as-terminal-needsinput-and-drops-the-pending-decision -->
...
<!-- id: composesystemprompt-in-auto-emits-the-unattended-directive -->
...
<!-- id: composesystemprompt-in-human-emits-a-distinct-interactive-ask-first-directive -->
...
<!-- id: composesystemprompt-in-either-mode-appends-the-directive-after-the-role-prompt-and-includes-the-envelope-sentinel -->
...
<!-- id: autoresolver-on-an-open-question-self-answers-a-non-empty-proceed-instruction-tagged-with-the-auto-source -->
...
<!-- id: autoresolver-on-a-permission-choice-never-self-answers-allow -->
...
<!-- id: codex-resume-reuses-the-prior-session-via-bypass-without-re-setting-cd-or-sandbox -->
...
<!-- id: codex-new-turn-sets-cd-and-bypasses-its-own-sandbox-since-the-box-is-the-wall -->
...
<!-- id: codex-driven-with-a-non-bypass-policy-throws-an-actionable-notsupportedexception-naming-the-policy -->
...
<!-- id: directive-composed-with-a-role-prompt-preserves-the-role-text-and-appends-the-directive -->
...
<!-- id: directive-composed-with-an-empty-role-prompt-returns-the-standalone-unattended-directive -->
...
<!-- id: text-without-the-sentinel-null-not-a-question -->
...
<!-- id: a-sentinel-with-a-well-formed-open-envelope-an-open-question-carrying-its-prompt -->
...
<!-- id: a-sentinel-with-a-well-formed-choice-envelope-a-choice-question-carrying-its-options-and-free-text-flag -->
...
<!-- id: a-sentinel-whose-json-is-wrapped-in-noise-fences-surrounding-prose-the-embedded-object-is-still-parsed -->
...
<!-- id: braces-inside-a-json-string-value-the-object-scan-stays-balanced-and-parses-correctly -->
...
<!-- id: a-sentinel-whose-json-cannot-be-parsed-an-open-question-whose-prompt-is-the-raw-tail -->
...
<!-- id: a-sentinel-with-no-json-object-at-all-an-open-question-whose-prompt-is-the-trailing-prose -->
...
<!-- id: an-open-envelope-with-an-empty-prompt-still-an-open-question -->
...
<!-- id: a-choice-envelope-missing-its-options-falls-back-to-an-open-question -->
...
<!-- id: multiple-sentinels-in-the-text-the-last-sentinel-s-envelope-is-the-parsed-question -->
...
<!-- id: claudepermission-isallow-on-an-answer-true-only-for-a-case-insensitive-trimmed-allow-else-false -->
