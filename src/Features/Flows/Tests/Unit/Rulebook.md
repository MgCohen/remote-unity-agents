...
<!-- id: flow-that-runs-every-operation-successfully-completed-with-each-operation-recorded-as-completed -->
...
<!-- id: snapshot-version-after-a-run-strictly-greater-than-before-the-run -->
...
<!-- id: flow-whose-operation-throws-failed-with-the-operation-failed-and-its-error-recorded -->
...
<!-- id: flow-that-passes-context-data-into-an-operation-s-args-that-data-appears-in-the-operation-s-recorded-result -->
...
<!-- id: flow-that-runs-operations-concurrently-every-operation-recorded-exactly-once-with-no-loss-or-corruption -->
...
<!-- id: changes-subscribed-after-a-run-finished-yields-the-latest-snapshot-once-then-completes -->
...
<!-- id: flowdefinition-built-from-a-type-that-is-not-a-flow-throws-argumentexception -->
...
<!-- id: flowdefinition-built-from-a-concrete-flow-type-exposes-that-type-as-its-flowtype -->
